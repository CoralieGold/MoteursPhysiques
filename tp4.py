...
def Modeleur() :
	...
	points.append(Particule(m=1, pos=Point(2, 2.5), v=Vecteur(3, 9), a=0, h=0.001, color="red"))
	points.append(Particule(m=1, pos=Point(3, 2.5), v=Vecteur(5, 2), a=0, h=0.001, color="blue"))
	points.append(Particule(m=1, pos=Point(4, 2.5), v=Vecteur(2, 1), a=0, h=0.001, color="green"))
	#points.append(PointFixe(pos=Point(5, 2.5), color="purple"))
	points.append(Particule(m=1, pos=Point(6, 2.5), v=Vecteur(1, 4), a=0, h=0.001, color="turquoise"))
	points.append(Particule(m=1, pos=Point(7, 2.5), v=Vecteur(2, 3), a=0, h=0.001, color="yellow"))
	points.append(Particule(m=1, pos=Point(8, 2.5), v=Vecteur(8, 8), a=0, h=0.001, color="black"))
	#points.append(PointFixe(pos=Point(9, 2.5), color="orange"))
	
	liaisons = []
	for i in range(len(points) - 1):
		liaisons.append(ParticlesSystem(points[i], points[i+1], k=50000, color="blue"))
	for p in points:
...
#==========================
  ...
  win=MainWindow("TP4",900,450,"lightgrey")
